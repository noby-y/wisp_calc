...
### How to start
1. Download [infini_wisp_calc.exe](https://github.com/noby-y/wisp_calc/releases/download/v1.1.1/infini_wisp_calc.exe) from the Release tab ( [infini_wisp_calc_linux](https://github.com/noby-y/wisp_calc/releases/download/v1.1.1/infini_wisp_calc_linux) if you're on Linux)
